...
var api = "localhost:3306"; //"80.167.223.178";
var HttpRequestType;
...
function Login(email, password) {
    return new Promise(function (resolve, rejects) {
        ...
        }).then(function (response) { return resolve(response); }).catch(function (err) { return rejects(err); });
    });
}
//@ts-ignore
...
function fetchData(url, requestType, bodyData) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch(IP + "/new", settings).catch(function (err) {
